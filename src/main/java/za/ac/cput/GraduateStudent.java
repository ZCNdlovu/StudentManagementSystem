...
public class GraduateStudent extends Student{
    ...
    public double calculateTuition() {
        // 1. Total Costs (Modules + Food + RA Fees)
        double moduleFees = this.modules * 1000.00;
        double foodAllowance = 5000.00 * 12;
        double raCost = this.researchAssistant ? (1000.00 * 12) : 0.0;

        double totalCosts = moduleFees + foodAllowance + raCost;

        // 2. The Calculation
        double netBalance = totalCosts - this.stipend;

        // If netBalance is positive, they owe money.
        // If it's negative, the stipend covered everything (return 0.0).
    ...
    public void displayStudentDetails() {
        ...
        // Recalculate for report visibility
